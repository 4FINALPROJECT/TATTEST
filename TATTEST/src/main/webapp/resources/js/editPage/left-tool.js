  ...
  handles: "all" ,autoHide:true
                ...
                $(".edit-wrap").droppable({
                    ...
                    if(ui.draggable.hasClass("dragTEXT") || ui.draggable.hasClass("dragTEXT2") || ui.draggable.hasClass("dragP") || ui.draggable.hasClass("dragFONT") || ui.draggable.hasClass("btn")) {
                        ...
                        $(".edit-view-body .btn").addClass("item-"+counts[0]);
                        ...
                        $(".edit-view-body .btn").addClass("imgSize-"+counts[0]);                     
                        
                        //Remove the current class (ui-draggable and dragImg)
                        $(".edit-view-body .item-"+counts[0]).removeClass("dragTEXT");
                        ...
                        $(".edit-view-body .item-"+counts[0]).removeClass("btn ui-draggable ui-draggable-dragging");
